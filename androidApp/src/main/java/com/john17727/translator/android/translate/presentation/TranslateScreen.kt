...
import com.john17727.translator.translate.presentation.TranslateState
import com.john17727.translator.android.R
import com.john17727.translator.android.translate.presentation.components.*
import com.john17727.translator.translate.domain.translate.TranslateError
import java.util.*
...
fun TranslateScreen(
    ...
    LaunchedEffect(key1 = state.error) {
        val message = when (state.error) {
            ...
            TranslateError.CLIENT_ERROR -> context.getString(R.string.error_service_unavailable)
            TranslateError.SERVER_ERROR -> context.getString(R.string.error_service_unavailable)
            TranslateError.UNKNOWN_ERROR -> context.getString(R.string.error_service_unavailable)
            null -> null
        }
